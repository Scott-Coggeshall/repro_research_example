...
# Colony Counts by Plate Number
```{r}

cleaned_data %>% ggplot(aes(x = as.numeric(plate_number), y = count, color = swab_type)) + geom_jitter(size = 2, alpha = .5, width = .2)  + theme_light() + facet_wrap( ~ swab_type) + geom_vline(xintercept = 20)
