...
cleaned_data %>% ggplot(aes(x = plate_number, y = count, color = ref_flag)) + geom_jitter(size = 2, alpha = .5, width = .2)  + theme_light() + facet_wrap( ~ plate_group, scales = "free_x") + scale_color_d3()
